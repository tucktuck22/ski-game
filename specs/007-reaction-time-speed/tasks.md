...
- [ ] T017 [US1] Commit T007–T016 and push to `claude/bold-albattani-pag0m9`, so the play-pass build has a named commit.
...
- [ ] T019 [US1] Record the maintainer's verdict in `specs/007-reaction-time-speed/spec.md` under a new "Playtest findings — <date>, build <sha>" section, in their own words, before any value moves again. If they ask for changes, loop back to T012–T016 and hand over again (T017–T018) rather than continuing.
