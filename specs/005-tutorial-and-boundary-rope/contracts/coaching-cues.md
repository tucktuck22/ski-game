...
/** Lead distance every cue is authored to. Derived in research R2, not chosen. */
export const CUE_LEAD = 389;
```
...
| 4   | Every cue's `from` is exactly `CUE_LEAD` before its object's x                   | FR-191, R2  |
